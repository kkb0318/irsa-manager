...
# kkb0318.github.io/irsa-manager-bundle:$VERSION and kkb0318.github.io/irsa-manager-catalog:$VERSION.
IMAGE_TAG_BASE ?= kkb0318.github.io/irsa-manager
...
.PHONY: all
all: fmt vet lint generate manifests kustomize helm generate-docs 
...
gen-helm-docs: $(HELM_DOCS) ## create helm docs.
	$(HELM_DOCS) --chart-search-root=./charts/irsa-manager
